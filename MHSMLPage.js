...
const MHSMLWebsite = () => {
  return (
    <div className="min-h-screen bg-white font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <section className="relative h-screen flex items-center overflow-hidden bg-[#0f172a]">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white leading-none uppercase mb-8">
              Mozaffar Hossain <br />
            ...
            <div className="mt-12 flex gap-6">
              <button className="px-10 py-5 bg-[#6A0DAD] text-white font-black rounded-2xl uppercase tracking-widest hover:bg-[#FF4500] transition-all shadow-2xl shadow-purple-500/20">
                Explore Capacity
              </button>
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            {/* ৪. BIOLOGICAL ETP (SUSTAINABILITY) */}
        ...
        <div className="container mx-auto px-6 relative">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              {/* ছোট ফ্লোটিং ইমেজ (Lab Test/PVA Gel) */}
              <motion.div 
                animate={{ y: [0, -20, 0] }}
                transition={{ duration: 4, repeat: Infinity }}
                className="absolute -bottom-10 -left-10 w-64 h-64 rounded-[3rem] border-[8px] border-white shadow-2xl overflow-hidden z-20"
              >
                <img 
                  src="public/images/etp-1.jpg" 
                  className="w-full h-full object-cover" 
      ...
      {/* 7. কোম্পানি ফটো গ্যালারি (Production Excellence) */}
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="mb-16">
            ...
            <p className="text-slate-500 font-bold mt-2">Inside Mozaffar Hossain Spinning Mills Ltd.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* ফ্যাক্টরি আউটলুক */}
            <div className="md:col-span-2 group relative overflow-hidden rounded-[3rem] h-[500px]">
              <img 
            ...
            {/* স্পিনিং ইউনিট ছবি */}
            <div className="group relative overflow-hidden rounded-[3rem] h-[500px]">
              <img 
                src="/images/company-bg.jpg" 
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" 
                alt="Spinning Unit" 
      ...
      <footer className="bg-white py-24 border-t border-slate-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-black text-[#6A0DAD] uppercase mb-8">Ready to Partner with MHSML?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <span className="font-black text-slate-900 uppercase">DSE: MHSML</span>
            </div>
            <div className="flex items-center gap-3">
              <Globe className="text-[#228B22]" />
              <span className="font-black text-slate-900 uppercase">Export Oriented</span>
            </div>
          </div>
          <div className="mt-16 pt-16 border-t border-slate-50 text-slate-400 text-sm font-bold uppercase tracking-widest">
            © 2024 SIM Group — All Rights Reserved.
          </div>
        </div>
      </footer>
    </div>
